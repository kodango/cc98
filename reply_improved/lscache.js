...
var lscache = (function() {
  ...
  var CACHE_PREFIX = 'lscache_';

  // Suffix for the key name on the expiration items in localStorage
  var CACHE_SUFFIX = '_ehcacsl';
  ...
  function supportsJSON() {
    ...
    if (cachedJSON === undefined) {
      cachedJSON = (window.JSON != null || JSON != null);
      //cachedJSON = ('JSON' in window);
    }
    return cachedJSON;
  }
  ...
  function setItem(key, value) {
    ...
    // For debug, otherwise in Firebug (1.10.0) + Scriptish 1.0.7 can't list the stored items.
